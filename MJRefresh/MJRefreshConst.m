...
const NSTimeInterval MJRefreshFastAnimationDuration = 0.25;
const NSTimeInterval MJRefreshSlowAnimationDuration = 0.4;
...
NSNotificationName const MJRefreshDidChangeLanguageNotification = @"MJRefreshDidChangeLanguageNotification";
